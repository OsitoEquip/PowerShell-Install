...
$Global:LogFileName = (split-path $MyInvocation.MyCommand.Definition -parent) + ".\acceptance-test-log.txt"
...
$Global:RaiseAssertionFilter = $null

$Global:DefaultTestCaseFilter = ".*"
$Global:TestConditionFilter = $null
